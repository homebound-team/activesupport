 ...
 * @example toPlainDate(new Date("2023-05-02T23:00:00Z"), "UTC") //=> PlainDate("2023-05-02")
 * @example toPlainDate(new Date("2023-05-02T23:00:00Z"), "America/New_York") //=> PlainDate("2023-05-02")
 */
