 ...
 * @example toLegacyDate(Temporal.PlainDate.from("2023-05-02"), "America/New_York") //=> Date("2023-05-02T04:00:00.000Z")
 * @example toLegacyDate(Temporal.PlainDate.from("2023-05-02"), "UTC") //=> Date("2023-05-02T00:00:00.000Z")
 */
