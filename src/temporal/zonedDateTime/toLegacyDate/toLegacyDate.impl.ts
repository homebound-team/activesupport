 ...
 * @returns A JavaScript Date object representing the same instant in time
 * @example toLegacyDate(Temporal.ZonedDateTime.from("2023-05-02T12:11:36.438+00:00[UTC]")) //=> Date("2023-05-02T12:11:36.438Z")
 */
