...
function mapToObjectImpl<T, K extends PropertyKey, V>(fn: CallbackFn<T, readonly [K, V]>): Record<K, V>;
function mapToObjectImpl<T, K extends PropertyKey, V>(
