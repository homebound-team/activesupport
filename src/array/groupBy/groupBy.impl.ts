 ...
 * @example groupBy([{name: "Alice", age: 25}, {name: "Bob", age: 25}], p => p.age) //=> {25: [{name: "Alice", age: 25}, {name: "Bob", age: 25}]}
 * @example groupBy([{name: "Alice", age: 25}, {name: "Bob", age: 30}], p => p.age, p => p.name) //=> {25: ["Alice"], 30: ["Bob"]}
